...
class QuestionControllerTest {
    ...
    void shouldFindQuestionById() throws Exception {
        // given
        QuestionDto question = createQuestionDto(1L, "question 1", "answer 1");
    ...
    void shouldReturn404WhenQuestionNotFound() throws Exception {
        ...
        when(questionService.findById(1L))
                .thenThrow(new ResourceNotFoundException("Question", 1L));
    ...
    void shouldReturnAllQuestions() throws Exception {
        ...
        List<QuestionDto> questions = List.of(
                createQuestionDto(1L, "question 1", "answer 1"),
                createQuestionDto(2L, "question 2", "answer 2")
        );
    ...
    void shouldCreateQuestion() throws Exception {
        // given
        QuestionCreateRequest request = createQuestionCreateRequest("question 1", "answer 1");

        QuestionDto response = createQuestionDto(1L, "question 1", "answer 1");
    ...
    void shouldReturn400WhenQuestionIsBlank() throws Exception {
        // given
        QuestionCreateRequest request = createQuestionCreateRequest("", "answer 1");
    ...
    void shouldReturn400WhenAnswerIsBlank() throws Exception {
        // given
        QuestionCreateRequest request = createQuestionCreateRequest("question 1", "");
    ...
    void shouldUpdateQuestion() throws Exception {
        // given
        QuestionCreateRequest request = createQuestionCreateRequest("new question", "new answer");

        QuestionDto response = createQuestionDto(1L, "new question", "new answer");
    ...
    private QuestionDto createQuestionDto(Long id, String question, String answer) {
    ...
    private QuestionCreateRequest createQuestionCreateRequest(String question, String answer) {
